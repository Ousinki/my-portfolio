...
\subsubsection{格式设置}
\textbf{加粗} \quad \textit{italic斜体} \quad \underline{下划线} \quad \underline{\textbf{嵌套}} % 在overleaf里仍然可以使用快捷键ctrl+B等等
...
\ruby{人工智能}{artificial intelligence} \quad \ruby{machine learning}{机器学习}
...
\begin{figure}[h] % figure 表示图形/图片。[h] 表示将图片放置在here
    \centering % 图片居中
